...
keys = {
    ...
    "menu": {
        ...
        "en": f"Subscription until: <b>$until</b>\n\nSelected server: <b>$server</b>\n\n<a href='{links['faq']['en']}'>FAQ</a>",
    ...
    "desc_1_day": {
        "ru": "Покупка подписки на 1 день",
        "en": "Purchase subscription for 1 day",
        "cn": "买1天订阅",
    },
    "desc_30_day": {
        "ru": "Покупка подписки на 1 месяц",
        "en": "Purchase subscription for 1 month",
        "cn": "买1个月订阅",
    },
    "desc_90_day": {
        "ru": "Покупка подписки на 3 месяца",
        "en": "Purchase subscription for 3 months",
        "cn": "买3个月订阅",
    },
    "desc_360_day": {
        "ru": "Покупка подписки на 1 год",
        "en": "Purchase subscription for 1 year",
        "cn": "买1年订阅",
    },
    "back": {
        "ru": "⏪ Назад",
